...
@SuppressWarnings("unused") class CompType {
	String name
	@SerializedName("JavaClass") String javaClass
	Map<String, Object> requiredMemory
	Map<String, Object> requiredStorage
	...
	new(Actor a, Component c) {
		...
		this.requiredMemory.put("JavaClass", "edu.vanderbilt.isis.chariot.datamodel.NodeCategory.DM_Memory")
		this.requiredMemory.put("memory", 0)
		this.requiredMemory.put("unit", "")
		this.requiredStorage.put("JavaClass", "edu.vanderbilt.isis.chariot.datamodel.NodeCategory.DM_Storage")
		this.requiredStorage.put("storage", 0)
		this.requiredStorage.put("unit", "") // for (Requirement r : c.getRequirements()){			
